...
const en: Record<string, string> = {
  ...
  'Tu música, conectada': 'Your music, connected',
  'Perfiles guardados': 'Saved profiles',
  'Añadir otra cuenta': 'Add another account',
  'Añadir cuenta': 'Add account',
  'Añadir perfil': 'Add profile',
  'Añadir otro perfil': 'Add another profile',
  'Elige el tipo de servidor': 'Choose the server type',
  'Servidor Subsonic': 'Subsonic server',
  'Compatible con Subsonic': 'Subsonic-compatible',
